...
class DirectoryStorage extends Storage {
    ...
    public function get(RepositoryInterface $repository, $id): EntityInterface {
        $filename = $this->getFilename($repository, $id);
     ...
     * @return string
     */
    protected function getFilename(RepositoryInterface $repository, $id): string {
    ...
    public function update(RepositoryInterface $repository, $id, array $data) {
        ...
        file_put_contents($this->getFilename($repository, $id), $content);
